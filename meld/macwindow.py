...
class MacWindow:
    ...
    def install_mac_additions(self):
        ...
        actions = (
            ...
            ("Save", Gtk.STOCK_SAVE, _("_Save"), None,
            ...
            ("Undo", Gtk.STOCK_UNDO, _("_Undo"), "<Primary>Z",
             _("Undo the last action"),
             self.on_menu_undo_activate),
            ("Redo", Gtk.STOCK_REDO, _("_Redo"), "<Primary><shift>Z",
             _("Redo the last undone action"),
             self.on_menu_redo_activate),
            ("Cut", Gtk.STOCK_CUT, _("Cu_t"), None, _("Cut the selection"),
             self.on_menu_cut_activate),
            ("Copy", Gtk.STOCK_COPY, _("_Copy"), None, _("Copy the selection"),
             self.on_menu_copy_activate),
            ("Paste", Gtk.STOCK_PASTE, _("_Paste"), None, _("Paste the clipboard"),
            ...
            ("Stop", Gtk.STOCK_STOP, _("Stop"), "Escape",
             _("Stop the current action"),
             self.on_toolbar_stop_clicked),
            ("Refresh", Gtk.STOCK_REFRESH, _("Refresh"), "<Primary>R",
             _("Refresh the view"),
